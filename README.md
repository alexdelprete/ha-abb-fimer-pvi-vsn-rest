...
- Examples:
  - `sensor.power_one_inverter_pvi_10_0_outd_077909_3g82_3112_power_ac`
...
- Examples:
  - `Power-One Inverter PVI-10.0-OUTD (077909-3G82-3112) Power AC`
...
- **English**: `Power-One Inverter PVI-10.0-OUTD (077909-3G82-3112) Power AC` → entity ID: `sensor.power_one_inverter_..._power_ac`
- **Italian**: `Power-One Inverter PVI-10.0-OUTD (077909-3G82-3112) Potenza AC` → entity ID: `sensor.power_one_inverter_..._potenza_ac`
- **French**: `Power-One Inverter PVI-10.0-OUTD (077909-3G82-3112) Puissance AC` → entity ID: `sensor.power_one_inverter_..._puissance_ac`
- **German**: `Power-One Inverter PVI-10.0-OUTD (077909-3G82-3112) AC-Leistung` → entity ID: `sensor.power_one_inverter_..._ac_leistung`
