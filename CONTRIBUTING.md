# Contributing to ABB/FIMER PVI VSN REST
...
pytest tests/ --cov=custom_components/abb_fimer_pvi_vsn_rest --cov-report=term-missing
```
...
ty check custom_components/abb_fimer_pvi_vsn_rest
```
