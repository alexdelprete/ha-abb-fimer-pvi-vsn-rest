...
DISPLAY_NAME_CORRECTIONS = {
    ...
    "Total DC energy from MPPT string 3": "String 3 Energy",
    "Total DC Energy (String 1)": "String 1 Energy",
    "Total DC Energy (String 2)": "String 2 Energy",
    "Total DC Energy (String 3)": "String 3 Energy",
    ...
    "DC current from MPPT string 3": "String 3 Current",
    ...
    "DC input power from MPPT string 3": "String 3 Power",
    "DC Input Power (String 1)": "String 1 Power",
    "DC Input Power (String 2)": "String 2 Power",
    "DC Input Power (String 3)": "String 3 Power",
    ...
    "DC string 3 connection status": "DC Input 3 Status",
    ...
    "Grid Voltage L1-N": "Grid Voltage L1-N",
    "Grid Voltage L2-N": "Grid Voltage L2-N",
    ...
    "DC string 3 input voltage": "DC Input 3 Voltage",
    ...
    "DC Voltage #3": "DC Voltage (String 3)",
}
...
DISPLAY_NAME_STANDARDIZATION = {
    ...
    "DC Current #3": "Current DC - String 3",
    ...
    "String 3 Current": "Current DC - String 3",
    ...
    "DC Voltage #3": "Voltage DC - String 3",
    ...
    "DC Input 3 Voltage": "Voltage DC - Input 3",
    "Shunt Voltage": "Voltage - Shunt",
    "Grid Voltage L1-N": "Voltage AC - Grid L1-N",
    "Grid Voltage L2-N": "Voltage AC - Grid L2-N",
    ...
    "DC Voltage (String 3)": "Voltage DC - String 3",
    ...
    "String 3 Energy": "Energy DC - String 3 Lifetime",
    ...
    # ========== MISCELLANEOUS MEASUREMENT ENTITIES ==========
    "Power factor": "Power Factor",
    "Power Factor": "Power Factor",
    "Power Factor (Cos Phi)": "Power Factor - Cos Phi",
    "MPPT Count": "MPPT Channel Count",
    "Battery Cycle Count": "Cycles",
    ...
    "DC energy (String 3) - Lifetime": "Energy DC - String 3 Lifetime",
    "Nominal Power": "Power - Nominal Rating",
    "Nominal Apparent Power": "Power - Nominal Apparent Rating",
    # ========== BATTERY ENTITIES (v1.3.8) ==========
    "Battery charge cycles counter": "Charge Cycles",
    "Battery discharge cycles counter": "Discharge Cycles",
    "Count - Battery Cycles": "Cycles",
    "Number of battery cells or modules": "Module Count",
    "State of Charge": "State of Charge",
    "State of Health": "State of Health",
    "Detected Battery Number": "Detected Number",
    "Battery Control Enabled": "Control Enabled",
    "Battery Control State": "Control State",
    # ========== STATUS ENTITIES (v1.3.8) ==========
    "Global operational state": "Status - Global",
    "Global Status": "Status - Global",
    "Inverter State": "Status - Inverter",
    "DC Input 1 State": "Status - DC Input 1",
    "DC Input 1 Status": "Status - DC Input 1",
    "DC Input 2 State": "Status - DC Input 2",
    "DC Input 3 State": "Status - DC Input 3",
    "DC Input 2 Status": "Status - DC Input 2",
    "DC Input 3 Status": "Status - DC Input 3",
    "Fault Ride Through (FRT) status": "Status - Fault Ride Through (FRT)",
    "Digital Input Status": "Status - Digital Input",
    "Grid External Control State": "Status - Grid External Control",
    "Alarm State": "Status - Alarm",
    "Alarm Status": "Status - Alarm",
    "Clock State": "Status - Clock",
    "Warning Flags": "Status - Warning Flags",
    # ========== INVERTER CONFIG ENTITIES (v1.3.8) ==========
    "Split-phase configuration flag": "Split Phase",
    "Input Mode": "Input Mode",
    "Commissioning Freeze": "Commissioning Freeze",
    "Dynamic Feed In Ctrl": "Dynamic Feed-In Control",
    "Energy Policy": "Energy Policy",
    "Model 126 Enabled": "Model 126 Enabled",
    "Model 132 Enabled": "Model 132 Enabled",
    "Type": "Type",
    "Configuration options": "Configuration Options",
    "Country grid standard setting": "Country Standard",
    "Count - MPPT Channels": "MPPT Channel Count",
    # ========== GRID ENTITIES (v1.3.8) ==========
    "Grid External Control Enabled": "External Control Enabled",
    # ========== POWER DERATING ENTITIES (v1.3.8) ==========
    "AC Power Derating Flags": "Power AC - Derating Flags",
    "Apparent Power Derating": "Power AC - Apparent Derating Flags",
    "Reactive Power Derating": "Reactive Power - Derating Flags",
    # ========== SYSTEM/DATALOGGER ENTITIES (v1.3.8) ==========
    "System Uptime": "Uptime",
    "System load average": "Load Average",
    "Available RAM": "Available RAM",
    "Available flash storage": "Available Flash",
    "Flash storage used": "Flash Used",
    "Central controller frequency": "Frequency - Central Controller",
    # ========== WIFI ENTITIES (v1.3.8) ==========
    "WiFi Local IP": "WiFi - Local IP",
    "WiFi Mode": "WiFi - Mode",
    "WiFi SSID": "WiFi - SSID",
    "WiFi link quality percentage": "WiFi - Link Quality",
    "WiFi AP Status": "WiFi - AP Status",
    "WiFi DHCP State": "WiFi - DHCP State",
    "WiFi DNS Server": "WiFi - DNS Server",
    "WiFi FSM Status": "WiFi - FSM Status",
    "WiFi IP Address": "WiFi - IP Address",
    # ========== DIGITAL INPUT ENTITIES (v1.3.8) ==========
    "Digital Input 0 Mode": "Digital Input - Mode 0",
    "Digital Input 1 Mode": "Digital Input - Mode 1",
    # ========== DEVICE INFO ENTITIES (v1.3.8) ==========
    "Communication Protocol": "Communication Protocol",
    "Device 0 Name": "Name 0",
    "Device 0 Type": "Type 0",
    "Device 1 Name": "Name 1",
    "Device 1 Type": "Type 1",
    "Device 2 Name": "Name 2",
    "Device 2 Type": "Type 2",
    "Device serial number": "Serial Number",
    "Firmware Build Date": "Firmware Build Date",
    ...
    "Logger Board Model": "Logger Board Model",
    "Logger Hostname": "Hostname",
    "Logger ID": "Logger ID",
    "Logger Serial Number": "Logger Serial Number",
    "Serial Number": "Serial Number",
    "Serial number": "Serial Number",
    "Manufacturer name": "Manufacturer",
    "Manufacturing Week/Year": "Manufacturing Week/Year",
...
SUNSPEC_TO_HA_METADATA = {
    ...
    "DCW_3": {"device_class": "power", "state_class": "measurement", "unit": "W"},
    ...
    "Pin3": {"device_class": "power", "state_class": "measurement", "unit": "W"},
    ...
    "DCA_3": {"device_class": "current", "state_class": "measurement", "unit": "A"},
    "MeterIgrid_L1": {
        "device_class": "current",
        "state_class": "measurement",
        "unit": "A",
    ...
    "DCV_3": {"device_class": "voltage", "state_class": "measurement", "unit": "V"},
    ...
    "IleakInv": {
        "device_class": "current",
        "unit": "mA",  # VSN700 reports uA; normalizer converts uA -> mA (/1000)
        "state_class": "measurement",
        "precision": 2,
    },
    "IleakDC": {
...
DESCRIPTION_IMPROVEMENTS = {
    ...
    "Ein3": "DC energy (String 3) - Lifetime",
    ...
    "Vin3": "DC string 3 input voltage",
    ...
    "DC3State": "DC string 3 operating state",
    ...
    "DCW_3": "DC Power (String 3)",
    "DCA_1": "DC Current (String 1)",
    "DCA_2": "DC Current (String 2)",
    "DCA_3": "DC Current (String 3)",
    "Hz": "Grid frequency",
    "PhVphA": "AC Voltage Phase A-N",
    "VgridL1_N": "Grid Voltage L1-N",
    "VgridL2_N": "Grid Voltage L2-N",
    ...
    "PbaT": "Total battery power aggregate",
