...
def categorize_point(p):
    ...
    if "State" in p or p in [
        ...
        return "State & Status"
    if p in ["PacTogrid", "PacStandAlone", "EBackup"]:
    ...
    if "Ctrl" in p or "mode" in p or "Ena" in p or "Flags" in p or "Mod" in p:
