...
| `VSN_NAME_NORMALIZATION` | VSN700→VSN300 name canonicalization |
...
Example: `abb_fimer_pvi_vsn_rest_inverter_0765433f712345_e0_since_restart`

### Entity ID Format

Entity IDs are auto-generated by Home Assistant from device name + entity name.

Example: `sensor.abb_fimer_pvi_vsn_rest_inverter_0765433f712345_e0_since_restart`
