...
This beta release adds configurable repair notifications with recovery script support, allowing users to automate
...
- **Configurable failures threshold** - Set how many consecutive failures (1-10) before triggering notification
  (default: 3)
