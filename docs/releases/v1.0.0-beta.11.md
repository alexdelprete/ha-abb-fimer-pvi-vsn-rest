...
**Release Date:** 2025-01-29 **Type:** Critical Hotfix
...
- `_attr_unique_id` got the full template: `"abb_vsn_rest_inverter_0765433f712345_m103_watts"` ✓
...
- `entity_id` (visible in entity registry): `"sensor.abb_vsn_rest_inverter_0765433f712345_m160_dc_current_1"` ✓
- `_attr_name` (visible in UI): `"DC Current #1"` ✓
- `_attr_unique_id` (internal registry): `"abb_vsn_rest_inverter_0765433f712345_m160_dc_current_1"` ✓
...
1. Configure VSN datalogger settings
...
+ sensor.abb_vsn_rest_inverter_0765433f712345_m160_dc_current_1  ✓ (beta.11 - correct)

- sensor.watts                   ❌ (beta.10 - broken)
+ sensor.abb_vsn_rest_inverter_0765433f712345_m103_watts  ✓ (beta.11 - correct)

- sensor.uptime                  ❌ (beta.10 - broken)
+ sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_uptime  ✓ (beta.11 - correct)
```text
...
1. **Filter by:** `abb_vsn_rest`
1. **Check entity IDs include full template:**
...
```text
sensor.abb_vsn_rest_inverter_0765433f712345_m103_watts
sensor.abb_vsn_rest_inverter_0765433f712345_m103_ac_current
sensor.abb_vsn_rest_inverter_0765433f712345_m160_dc_current_1
...
sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_manufacturer
```text
...
1. **custom_components/abb_fimer_pvi_vsn_rest/manifest.json**

   - Line 13: Version bumped to `1.0.0-beta.11`

1. **custom_components/abb_fimer_pvi_vsn_rest/const.py**
...
Because `_attr_name` is the **user-facing display name** shown in the UI. Users want to see friendly names like "DC Current #1", not ugly template strings like
"abb_vsn_rest_inverter_0765433f712345_m160_dc_current_1".
...
1. **Verify version:** Settings → Devices & Services → ABB/FIMER PVI VSN REST → Version should be 1.0.0-beta.11
1. **Check logs:** Settings → System → Logs (filter by `abb_fimer_pvi_vsn_rest`)
1. **Report issues:** [GitHub Issues](https://github.com/alexdelprete/ha-abb-fimer-pvi-vsn-rest/issues)
...
**Commit:** `fix: entity_id generation bug (hotfix for beta.10)` **Tag:** `v1.0.0-beta.11`
