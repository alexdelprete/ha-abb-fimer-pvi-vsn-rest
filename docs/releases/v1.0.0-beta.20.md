...
- Before: `ABB/FIMER Datalogger VSN300 (110033-3A)`
- After: `ABB/FIMER Datalogger VSN300 (110033-3A16-1234)`

**Technical Details**:

The `_format_device_name()` function was using a compacted 8-character serial number for display purposes. This has been
changed to use the full original serial number with dashes
preserved.
