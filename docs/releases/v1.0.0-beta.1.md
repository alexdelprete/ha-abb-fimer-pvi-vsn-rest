...
This is the **first beta release** of the ABB/FIMER PVI VSN REST integration for Home Assistant. This new integration
provides native REST API support for ABB/FIMER/Power-One
