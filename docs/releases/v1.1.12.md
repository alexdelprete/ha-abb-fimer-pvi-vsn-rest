...
This release fixes duplicate sensor entries by implementing VSN name normalization that prioritizes VSN300
(SunSpec-based) names as canonical when merging sensors that exist in
