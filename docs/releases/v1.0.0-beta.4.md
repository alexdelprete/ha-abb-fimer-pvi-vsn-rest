...
**Note:** v1.0.0-beta.3 contained incorrect version strings in manifest.json and const.py (showed "1.0.0-beta.2"). This
is corrected in v1.0.0-beta.4.
...
```text
ValueError: Sensor sensor.vsn300_110033_3a16_1234_type has device class 'None',
...
- `sn`: "110033-3A16-1234" (serial number)
- `pn`: Part numbers
...
`via_device` ('abb_fimer_pvi_vsn_rest', '110033-3A16-1234').
