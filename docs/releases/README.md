...
This document describes the release workflow for the ABB/FIMER PVI VSN REST integration.
...
2. `custom_components/abb_fimer_pvi_vsn_rest/const.py` -> `VERSION = "X.Y.Z"`
3. Git tag -> `vX.Y.Z`
