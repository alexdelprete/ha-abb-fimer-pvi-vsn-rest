...
This release fixes an issue where VSN devices with authentication disabled could not be configured. Previously, the detection logic expected a 401 (Unauthorized) response to
