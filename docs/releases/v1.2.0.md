...
5. **Delete orphaned entities**: Settings → Devices & Services → Entities → Filter by "unavailable" → Delete old `*_lifetime` entities
6. **Clean up statistics**: Developer Tools → Statistics → Fix issues for orphaned entity IDs
