...
This release fixes a long-standing bug where 15 energy sensors that track "since restart" values were incorrectly named with `_lifetime` suffix in their entity IDs. The VSN700 REST
...
| Old Entity ID | New Entity ID | |---------------|---------------| | `*_e0_lifetime` | `*_e0_since_restart` | | `*_e1_lifetime` | `*_e1_since_restart` | | `*_e2_lifetime` |
`*_e2_since_restart` | | `*_e3_lifetime` | `*_e3_since_restart` | | `*_e4_lifetime` | `*_e4_since_restart` | | `*_e5_lifetime` | `*_e5_since_restart` | | `*_e6_lifetime` |
`*_e6_since_restart` | | `*_e7_lifetime` | `*_e7_since_restart` | | `*_e8_lifetime` | `*_e8_since_restart` | | `*_e15_lifetime` | `*_e15_since_restart` | | `*_ein_lifetime` |
`*_ein_since_restart` | | `*_e_charge_lifetime` | `*_e_charge_since_restart` | | `*_e_discharge_lifetime` | `*_e_discharge_since_restart` | | `*_e_tot_charge_lifetime` |
