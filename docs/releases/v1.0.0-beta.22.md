...
This release implements major improvements to entity identification and display naming to provide better namespace
isolation and enable superior entity grouping in Home Assistant's
UI.
...
**Problem**: Entity IDs lacked domain prefixing, making them prone to conflicts with other integrations and lacking
...
```text
sensor.inverter_0765433f712345_ac_power
...
```text
sensor.abb_fimer_pvi_vsn_rest_inverter_0765433f712345_ac_power
...
```text
abb_vsn_rest_inverter_0765433f712345_ac_power
```text

**After (beta.22)**:

```text
abb_fimer_pvi_vsn_rest_inverter_0765433f712345_ac_power
```text
...
- **Old**: `sensor.inverter_0765433f712345_ac_power`
- **New**: `sensor.abb_fimer_pvi_vsn_rest_inverter_0765433f712345_ac_power`
