...
This release adds support for REACT2 inverters and improves the VSN authentication detection logic. REACT2 devices use
VSN700 dataloggers with preemptive Basic authentication but
