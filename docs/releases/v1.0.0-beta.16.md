...
- `docs/releases/v1.0.0-beta.16.md` - This document
...
2. ✓ Temperature units show "°C" instead of "degC"
3. ✓ Temperature sensors display with 1 decimal precision
4. ✓ Timestamp sensor (sys_time) converts to datetime with HA timezone
5. ✓ All energy point time periods use consistent suffixes (- Total, - Lifetime, - Week, - Month, - Year, - Today)
6. ✓ No "counter" word in energy descriptions
7. ✓ Phase naming is consistent across all points (A/B/C/N format)
8. ✓ No "measurement" word in descriptions
9. ✓ String references use concise "(String #)" format
10. ✓ All improved point descriptions (GlobState, PowerPeakAbs, sys_load, store_size, PF, etc.)
11. ✓ Display names are clean and concise (cosPhi, mfg_week_year)
12. ✓ Excel and JSON mappings are in sync
13. ✓ Generator script works correctly
14. ✓ No ruff errors or warnings
