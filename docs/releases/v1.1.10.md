...
This is a **critical hotfix** release that addresses a bug in v1.1.9 where energy sensors still displayed Wh instead of
kWh even after fresh installation.
...
1. Normalizer converted values Wh→kWh ✓
