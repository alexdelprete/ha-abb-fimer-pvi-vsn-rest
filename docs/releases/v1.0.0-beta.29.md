...
| File | Lines | Change | |------|-------|--------| | discovery.py | 362 | Add device_type assignment for datalogger | | sensor.py | 415-433 | Modify conversion to check point_name
instead of device_class | | sensor.py | 425 | Return formatted string instead of datetime object | | vsn-sunspec-point-mapping.json | 544 | Remove device_class timestamp | |
