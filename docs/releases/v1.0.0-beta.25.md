...
This release **properly** fixes the entity ID generation issue by implementing the correct approach: using `has_entity_name=True` with technical device names. Beta.24's fix was
...
1. Use technical device names: `abb_fimer_pvi_vsn_rest_datalogger_1110333n161421`
...
```text
Entity ID: sensor.abb_fimer_pvi_vsn_rest_datalogger_1110333n161421_wlan0_essid ✅
...
- Result: `sensor.abb_fimer_pvi_vsn_rest_datalogger_1110333n161421_wlan0_essid` ✅
...
- ✅ Serial compacted: `111033_3n16_1421` → `1110333n161421`
