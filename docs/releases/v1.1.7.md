...
This release transforms the sensor mapping workflow by codifying ALL sensor fixes from v1.1.3-v1.1.7 into the generator script. The generator is now the **single source of truth**
...
**Solution**: Extended the generator script (`generate_mapping.py`) to include ALL sensor metadata, making it the permanent source of truth.
