...
**ALL entity IDs have changed.** This release completely redesigns the entity ID format to include full device context, preventing ID collisions in multi-device systems and
