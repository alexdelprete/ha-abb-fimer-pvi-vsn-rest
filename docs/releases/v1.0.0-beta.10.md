...
**ALL entity IDs have changed.** This release completely redesigns the entity ID format to include full device context,
preventing ID collisions in multi-device systems and
providing clear device identification.
...
sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_product_number
sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_device_address
sensor.abb_vsn_rest_inverter_0765433f712345_m103_watts
```text
...
1. Note down old entity IDs from your dashboards/automations
1. Find corresponding new entity IDs in Developer Tools → States
1. Update all references in dashboards, automations, scripts
1. Old entities will be marked as "unavailable" - you can safely delete them

______________________________________________________________________

## Overview

This release implements a comprehensive entity ID template redesign to support multi-device systems and provide clear device identification. The new format includes device type,
serial number, and model information directly in the entity ID.
...
1. **Device Type:** `inverter`, `datalogger`, `meter`, `battery` (simple, lowercase)
1. **Device S/N:** Compacted (remove `-`, `:`, `_`), lowercase
1. **Model:**
   - SunSpec points: `m1`, `m103`, `m160`, `m64061`, `m203`, `m802`, etc.
   - VSN-only points: `vsn300`, `vsn700`
1. **Point Name:** Simplified, lowercase (e.g., `watts`, `dc_current_1`, `uptime`)

______________________________________________________________________

## Examples

### Inverter Sensors (PVI-10.0-OUTD, S/N: 076543-3F71-2345)

**SunSpec Common Model (M1) - Diagnostic:**

- `sensor.abb_vsn_rest_inverter_0765433f712345_m1_manufacturer`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m1_model`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m1_serial_number`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m1_version`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m1_device_address`

**SunSpec Inverter Model (M103):**

- `sensor.abb_vsn_rest_inverter_0765433f712345_m103_watts`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m103_amps`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m103_phase_voltage_an`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m103_hz`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m103_pf`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m103_cabinet_temperature`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m103_daily_energy`

**SunSpec MPPT Model (M160):**

- `sensor.abb_vsn_rest_inverter_0765433f712345_m160_dc_current_1`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m160_dc_voltage_1`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m160_dc_power_1`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m160_dc_current_2`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m160_dc_voltage_2`

**ABB Proprietary Model (M64061) - Diagnostic:**

- `sensor.abb_vsn_rest_inverter_0765433f712345_m64061_alarm_state`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m64061_ground_resistance`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m64061_isolation_resistance`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m64061_leakage_current_dc_ac`
- `sensor.abb_vsn_rest_inverter_0765433f712345_m64061_daily_energy`

### VSN300 Datalogger Sensors (S/N: 110033-3A16-1234)

**System Monitoring - Diagnostic:**

- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_uptime`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_firmware_version`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_flash_free`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_ram_free`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_system_load`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_flash_used`

**Device Info - Diagnostic:**

- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_product_number`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_serial_number`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_device_type`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_wifi_network_name`
- `sensor.abb_vsn_rest_datalogger_1100333a161234_vsn300_wifi_local_ip_address`
...
1. **`_compact_serial_number(serial: str) -> str`**
   ...
   - Example: `"076543-3F71-2345"` → `"0765433f712345"`

1. **`_simplify_device_type(device_type: str) -> str`**
...
1. **`_determine_model_for_entity_id(point_model, vsn_model, is_datalogger) -> str`**
...
- Inverter 1: `sensor.abb_vsn_rest_inverter_0765433f712345_m1_manufacturer` ✅
...
- All `abb_vsn_rest_inverter_0765433f712345_*` entities appear together
- All `abb_vsn_rest_datalogger_1100333a161234_*` entities appear together
...
1. **convert_excel_to_json.py** (NEW, +70 lines)
...
1. **docs/vsn-sunspec-point-mapping.json** (Regenerated)
1. **custom_components/.../data/vsn-sunspec-point-mapping.json** (Regenerated)
...
1. **Mixed System (meter + battery + inverters):**
...
1. Verify entity_id format matches template
1. Verify unique_id matches entity_id
1. Verify friendly names unchanged
1. Verify diagnostic entities properly categorized
...
**Example:** `sensor.abb_vsn_rest_inverter_0765433f712345_m103_phase_voltage_an`
...
1. Find old unavailable entities
1. Click entity → Settings icon → Delete
...
1. Search by friendly name (e.g., "AC Power")
1. New entity ID will be listed
...
| Old Entity ID | New Entity ID | |---------------|---------------| | `sensor.manufacturer` | `sensor.abb_vsn_rest_datalogger_{sn}_vsn300_manufacturer` | | `sensor.device_address`
| `sensor.abb_vsn_rest_inverter_{sn}_m1_device_address` | | `sensor.watts` | `sensor.abb_vsn_rest_inverter_{sn}_m103_watts` | | `sensor.dc_current_1` |
`sensor.abb_vsn_rest_inverter_{sn}_m160_dc_current_1` | | `sensor.uptime` | `sensor.abb_vsn_rest_datalogger_{sn}_vsn300_uptime` |
