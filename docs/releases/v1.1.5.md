# Release v1.1.5 - Cycle Counter Display Fix

**Release Date**: 2025-11-16

**Type**: Patch Release (Display Fix)

**Focus**: Fix decimal display for cycle counter sensors without units

---

## Overview

This patch release fixes an issue where cycle counter sensors (Chc, Dhc, CycleNum) were still displaying decimal places despite v1.1.4's precision fix. The root cause was a Home Assistant limitation: `suggested_display_precision` attribute does not work for sensors without units of measurement.

User **@wrongisthenewright** reported that cycle counters still showed decimals (e.g., "82277504.0") and that CycleNum incorrectly displayed with "cycles" unit.
